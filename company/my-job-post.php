      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-job-post.php"><i class="fa fa-file-o"></i> My E-Rozgar Post</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>My E-Rozgar Posts</i></h2>
            <p>In this section you can view all E-Rozgar posts created by you.</p>
