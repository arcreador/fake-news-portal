...
if(isset($_POST)) {
	...
	/*
	$stmt = $conn->prepare("INSERT INTO job_post(id_company, fakenewstitle, aboutfake, image) VALUES(?, ?, ?, ?)");
	$stmt->bind_param("isss", $_SESSION['id_company'], $fakenewstitle, $aboutfake, $image);
	*/
