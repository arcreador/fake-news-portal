		...
		<div class="four-grids">
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Approved Fake News</h3>
								<h4>
									<?php
									$db = new PDO('mysql:host=localhost;dbname=fake_news_portal;charset=utf8', 'root', 'mysql');
									$query = $db->query('SELECT COUNT(*) AS count FROM fake_news WHERE approval_status = "1"');
									$countq = $query->fetch();
									$query->closeCursor();
									echo $countq['count'];
									?>
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Pending Fake News</h3>
								<h4>
									<?php
									$db = new PDO('mysql:host=localhost;dbname=fake_news_portal;charset=utf8', 'root', 'mysql');
									$query = $db->query('SELECT COUNT(*) AS count FROM fake_news WHERE approval_status = "2"');
									$countq = $query->fetch();
									$query->closeCursor();
									echo $countq['count'];
									?>
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Ignored Fake News</h3>
								<h4>
									<?php
									$db = new PDO('mysql:host=localhost;dbname=fake_news_portal;charset=utf8', 'root', 'mysql');
									$query = $db->query('SELECT COUNT(*) AS count FROM fake_news WHERE approval_status = "3"');
									$countq = $query->fetch();
									$query->closeCursor();
									echo $countq['count'];
									?>
