...
$sql = "UPDATE fake_news SET approval_status = '3' WHERE id_fakepost = '$id' ";
...
<div class="four-grids">
		    <h1>
				...
				$id = $_REQUEST['id'];
				$query = $db->query("SELECT * FROM fake_news WHERE id='".mysql_real_escape_string($id)."'");
				$title = $query->fetch();
				$query->closeCursor();
				echo $title['title'];
				?>
			...
			<form action="" method="post">
			    ...
			    <input type="submit" value=" Ignore " name="submit"/><br/>
			</form>
</div>
