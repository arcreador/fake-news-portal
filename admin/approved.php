...
<?php
$sql = 'SELECT * 
		FROM fake_news WHERE approval_status = "1" ';
...
<!--heder end here-->
	...
	<table class="data-table" rules="rows">
		<caption class="title">Approved Fake News</caption>
		<thead>
			<tr>
				<th>NO</th>
				<th>Posted By</th>
